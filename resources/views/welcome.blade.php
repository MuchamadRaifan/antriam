...
<body>
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="features.html">Pendaftaran Online</a></li>
                    <li><a href="pricing.html">Informasi</a></li>
                    <li><a href="blog.html">Antrian</a></li>
                    <li class="dropdown"><a href="#"><span>Petunjuk</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
    ...
    <main id="main">
        ...
        <section class="section">
            <div class="container">
                ...
                <div class="row justify-content-center text-center mb-5">
                    <div class="col-md-5" data-aos="fade-up">
                        <h3 class="section-heading">PENGATURAN SIM ANTRIAN</h3>
                    </div>
                </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-md-7">
                    <p class="copyright">&copy; Copyright PT Raii. All Rights Reserved</p>
                    <div class="credits">
                        <!---->
                        Designed by <a href="https://www.instagram.com/mhmdraii26_/">Raifan</a>
                    </div>
                </div>
            </div>
